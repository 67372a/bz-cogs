...
DEFAULT_GUILD = {
    ...
    "direct_image_generation_parameters": None,
    "direct_image_generation_system_prompt": None,
    "direct_image_edit_parameters": None,
    "direct_image_edit_system_prompt": None,
